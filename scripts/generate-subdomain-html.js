...
function generateHTML(page) {
  ...
  // Try to use /og/{categoryUrl}-near-me.png if it exists, otherwise fall back to /og/services-near-me.png
  let ogImage = '/og/services-near-me.png';
  if (page.categoryUrl) {
    const categoryOgImage = `/og/${page.categoryUrl}-near-me.png`;
    const publicDir = path.join(__dirname, '../public');
    const categoryOgImagePath = path.join(publicDir, `og/${page.categoryUrl}-near-me.png`);
...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="https://near-me.us/og/services-near-me.png" />
    ...
    <meta property="twitter:image" content="https://near-me.us/og/services-near-me.png" />
