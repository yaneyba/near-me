...
const AdminDashboardPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const businessSubmissionsData =
        await dataProvider.getBusinessSubmissions();
      console.log(
        "✅ Loaded",
        businessSubmissionsData.length,
  ...
  const handleApproveBusinessSubmission = async (id: string) => {
    try {
      ...
      console.log(
        "Business submission approved and business created successfully"
      );
      alert(
        "Business submission approved successfully! Business has been added to the directory."
      );
    } catch (error) {
  ...
  const handleRejectBusinessSubmission = async (id: string, notes?: string) => {
    try {
      ...
      await dataProvider.rejectBusinessSubmission(
        id,
  ...
  const getFilteredBusinesses = () => {
    return businesses.filter((business) => {
      // Apply status filter
      if (statusFilter === "active" && business.status !== "active")
        return false;
      if (statusFilter === "inactive" && business.status !== "inactive")
        return false;
                            ...
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                onClick={() => {
                                  ...
                                  alert(
                                    `View details for ${submission.business_name}`
                                  );
                                }}
                              ...
                              {submission.status === "pending" && (
                                <>
                                  <button
                                    onClick={() =>
                                      handleApproveBusinessSubmission(
                                        submission.id
                                      )
                                    }
                                  ...
                                  <button
                                    onClick={() =>
                                      handleRejectBusinessSubmission(
                                        submission.id
                                      )
                                    }
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    ...
                    {businessesPagination.getTotalPages(
                      getFilteredBusinesses().length
                    ) > 1 &&
                      ` • Page ${
                        businessesPagination.currentPage
                      } of ${businessesPagination.getTotalPages(
                        getFilteredBusinesses().length
                      )}`}
                  </p>
                </div>
              ...
              {getFilteredBusinesses().length === 0 ? (
                ...
                <>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {businessesPagination
                          .getPaginatedItems(getFilteredBusinesses())
                          .map((business: any) => (
                                ...
                                <div className="flex items-center justify-end space-x-2">
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      alert(
                                        `Toggle premium status for ${business.name}`
                                      );
                                    }}
                  ...
                  <Pagination
                    ...
                    totalPages={businessesPagination.getTotalPages(
                      getFilteredBusinesses().length
                    )}
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center text-sm text-gray-500 mb-2">
                            ...
                            {message.city && (
                              <div>
                                <strong>City:</strong> {message.city}
                              </div>
                            )}
                          </div>
                          ...
                          <div className="text-sm text-gray-500 mb-4">
                            ...
                            {message.resolved_at && (
                              <div>
                                Resolved: {formatDate(message.resolved_at)} by{" "}
                                {message.resolved_by}
                              </div>
                            )}
                          </div>
                            ...
                            onClick={() => {
                              ...
                              window.open(
                                `mailto:${
                                  ...
                                  message.name
                                },%0D%0A%0D%0AThank you for contacting us.%0D%0A%0D%0AOriginal message:%0D%0A${encodeURIComponent(
                                  message.message
                                )}`
                              );
                            }}
                          ...
                          {message.status !== "resolved" && (
                            <button
                              onClick={async () => {
                                ...
                                try {
                                  await dataProvider.resolveContactMessage(
                                    message.id,
                                    "admin",
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => {
                    ...
                    alert(
                      "Create business profile functionality would be implemented here"
                    );
                  }}
                            ...
                            <div className="flex items-center justify-end space-x-2">
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  alert(
                                    `Delete business profile for ${user.email}`
                                  );
                                }}
                                className="text-red-600 hover:text-red-900 p-1"
            ...
            <div>
              ...
              <div className="text-center py-12 bg-gray-50 rounded-xl">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  In a production environment, this section would display charts
                  and metrics for platform usage, user growth, business
                  submissions, and other key performance indicators.
                </p>
              </div>
            </div>
          )}
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">
                              Allow users to log in to their accounts. When
                              disabled, users will be redirected to the home
                              page if they try to access the login page.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">
                              Track user interactions with business listings,
                              including views, phone calls, website clicks, and
                              other engagement metrics. When disabled, no user
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="mt-2 text-sm text-yellow-700 space-y-2">
                        <p>
                          <strong>Login Setting:</strong> Disabling login will
                          prevent all users from accessing their accounts,
                          including business owners. This should only be used
                          for maintenance or security purposes.
                        </p>
                        <p>
                          <strong>Tracking Setting:</strong> Disabling tracking
                          will stop all user engagement data collection across
                          all sites. This will affect analytics and reporting
                          for all businesses.
                        </p>
                      </div>
                    </div>
